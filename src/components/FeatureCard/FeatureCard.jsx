...
export default function FeatureCard({ feature, index = 0 }) {
  return (
    <AnimationWrapper delay={Math.min(index * 0.05, 0.3)} className="h-full">
      <article className="group h-full rounded-[1.25rem] bg-bg-primary/70 p-6 shadow-[var(--shadow-soft)] ring-1 ring-text-primary/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-[var(--shadow-lift)] sm:p-7">
